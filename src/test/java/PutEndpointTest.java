...
class PutEndpointTest {
    ...
    boolean put(long ts, String value) throws ExecutionException, InterruptedException {
        ...
        var res = PutEndpoint.runAsync(conn, tableName, request).get();
        assertFalse(res.getError(), res.getErrorMsg());
        return res.getResult();
    }

    void check(long ts, String value, boolean committed) throws ExecutionException, InterruptedException {
        var res = TestUtil.get(conn, tableName, row, ts, family);
    ...
    @Test
    void putNoConflicts() throws ExecutionException, InterruptedException {
    ...
    @Test
    void putConflict() throws ExecutionException, InterruptedException {
        TestUtil.DeleteTable(conn, tableName);
        TestUtil.CreateTable(conn, tableName, family);
    ...
    @Test
    void putAndGetRandomly() throws ExecutionException, InterruptedException {
        TestUtil.DeleteTable(conn, tableName);
        TestUtil.CreateTable(conn, tableName, family);
